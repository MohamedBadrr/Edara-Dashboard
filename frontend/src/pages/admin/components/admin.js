...
const Admin = () => {
  return (
    <div className='home-list'>
     ...
     <button className='b1'> WareHouses</button></Link>
      </div>
      ...
      <img src={image3} alt="photo"/>
        ...
        <button className='b1'>Supervisors</button></Link>
       </div>
      ...
      <img src={image4} alt="photo"/>
        ...
        <button className='b1'>Requests </button></Link>
       </div>
      ...
      <img src={image5} alt="photo"/>
        ...
        <button className='b1'> History Of Requests</button></Link>
       </div>
