...
.catch((err)=>{
  ...
  return (
    <>
    <div>
    <div style={{marginBottom:"40px",marginTop:"20px",height:"540px"}} className='form-container'>
         {/* <h1 className='newWare-t'>Send Request</h1> */}
         <h1 style={{padding:"10px" ,border:"solid 1px #e4e4e4" ,borderRadius:"5px",width:"55%",margin:"30px auto" ,backgroundColor:"#e4e4e4"}} className='titleAllProducts'>Send Request</h1>
          ...
          request.success && (
            ...
            <div class="alert success">
              ...
              <br class="clear"/></span>
                    ...
                    <h1  style={{margin:"50px 10px"}}>Your Stock will Be  = {product.stock+request.amount}</h1>
