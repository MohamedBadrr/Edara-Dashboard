...
const WareHouseList = () => {
  ...
  return (
    ...
    <div >
      ...
      <h1 style={{padding:"10px 90px" ,border:"solid 1px black" ,borderRadius:"10px",width:"500px" ,marginLeft:"280px",backgroundColor:"#e4e4e4"}}>All Warehouses</h1>
       <button style={{
        padding:"10px" , height:"45px" ,textAlign:"center",borderRadius:"5px" ,marginLeft:"240px" , marginTop:"35px"
