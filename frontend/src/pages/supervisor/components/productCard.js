...
const ProductCard = (props) => {
  ...
  return (
      ...
      <div className="card-top1">
        <img className='img' src={"http://localhost:4000/"+props.image} alt="photo"/>
        </div>
        <div className="card-info">
        <h3 style={{display:"inline"}} className="title">Name: </h3> <h3 style={{display:"inline",color:" rgb(21, 117, 164)"}}>
           {props.name}</h3><br></br>
