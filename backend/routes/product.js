...
// create product
router.post('/add-product/:warehouseId',admin,upload.single("photo"),
...
// update product 
router.put('/update-product/:productId',admin,upload.single("photo"),
body("name").isString().withMessage("please enter a valid product name").isLength({min:1}).withMessage("product name should be more than 3 characters !"),
body("discription").isString().withMessage("please enter a valid product discription").isLength({min:1}).withMessage("product name should be more than 10 characters !"),
body("stock").isNumeric().withMessage("please enter a valid product stock").isLength({min:1}).withMessage("product stock should be more than 1 number !"),
async (req,res) => {
    try {
        // request validation 
